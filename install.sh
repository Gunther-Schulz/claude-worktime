...
echo "Data:   $DATADIR/"
echo ""
echo "Recommended: enable the cold guard — uncomment CACHE_GUARD_TTL=3600 in"
echo "the config. It warns before an idle gap forces a full-context rewrite."
echo "Off by default because it blocks a prompt rather than just informing you."
echo ""
echo "Usage:"
