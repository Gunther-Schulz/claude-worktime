...
STATUSLINE_FORMAT_2="{timeline} {today} · {since_break} {last_break} · {rate_5h} ↻{rate_5h_reset} {rate_5h_proj} · ctx {context} · {rate_7d} 7d ↻{rate_7d_day} {rate_7d_proj}"
STATUSLINE_FORMAT_3=""
...
# Result: my-org/my-project (main ✓) · ⏱  today 2h32m · total 12h30m
#         ▮▯▯▮▮▮▮▮▮▮▮▮▮▮▮▯▯▮▮▮ 5h02m · ▶1h12m ⏸ 20m · ◑30% ↻3h21m →51% · ctx 77% ⟳99%
#         Opus 4.6 · $1.23
#
# ===========================================================================
